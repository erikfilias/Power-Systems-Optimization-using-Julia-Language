...
# m = Model(with_optimizer(AmplNLWriter.Optimizer, "/Users/Computer/ampl/bonmin"))
 m = Model(with_optimizer(AmplNLWriter.Optimizer, "/Users/Computer/ampl/couenne"))
...
optimize!(m)
print("Status of the problem is ", termination_status(m), "\n")
